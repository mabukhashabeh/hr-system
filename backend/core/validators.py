...
class AgeValidator:
    ...
    def __eq__(self, other):
        return isinstance(other, AgeValidator) and self.min_age == other.min_age and self.max_age == other.max_age
...
class ExperienceValidator:
    ...
    def __eq__(self, other):
        return (
            isinstance(other, ExperienceValidator)
            and self.min_years == other.min_years
            and self.max_years == other.max_years
        )
