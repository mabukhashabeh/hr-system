...
from .models import Candidate, Department, ApplicationStatus, StatusHistory
...
class CandidateFilter(django_filters.FilterSet):
    ...
    status = django_filters.ChoiceFilter(
        ...
        help_text="Filter by current application status"
    )
...
class StatusHistoryFilter(django_filters.FilterSet):
    ...
    candidate = django_filters.UUIDFilter(
        field_name='candidate__id',
        help_text="Filter by candidate ID"
    )
    ...
    admin_name = django_filters.CharFilter(
        lookup_expr='icontains',
        help_text="Filter by admin name"
    )

    created_after = django_filters.DateTimeFilter(
        field_name='created_at',
        lookup_expr='gte',
        help_text="Status changes after this date"
    )

    created_before = django_filters.DateTimeFilter(
        field_name='created_at',
        lookup_expr='lte',
        help_text="Status changes before this date"
    )
