...
from candidate.models import Candidate, StatusHistory, ApplicationStatus
...
class CandidateRegistrationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'years_of_experience', 'department', 'resume', 'age',
...
class StatusHistorySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'previous_status',
            'new_status', 'feedback',
            'admin_name', 'admin_email', 'created_at'
        ]
...
class CandidateStatusSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Candidate
        fields = [
            'id', 'email', 'department', 'full_name', 'current_status', 'current_status_display', 'years_of_experience', 'phone',
            'status_history', 'created_at',
        ]
        read_only_fields = [
            'id', 'full_name', 'years_of_experience', 'phone', 'current_status', 'created_at',
            'updated_at'
        ]
...
class StatusUpdateSerializer(serializers.Serializer):
    ...
    feedback = serializers.CharField(
        required=True,
        max_length=1000,
        help_text="Feedback for the status change"
    )
    admin_name = serializers.CharField(
        max_length=255,
        required=True,
        help_text="Name of the admin making the change"
    )
    admin_email = serializers.EmailField(
        required=True,
        help_text="Email of the admin making the change"
    )
...
class CandidateDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Candidate
        fields = [
            'id', 'full_name', 'email', 'phone', 'date_of_birth', 'age',
            'years_of_experience', 'department',
            'current_status', 'resume_url',
